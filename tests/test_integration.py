...
class TestIntegration(unittest.TestCase):
    ...
    def run_script_and_assert(self, command, expected_result=None, expected_result_contains=None):
        try:
            result = subprocess.run(command, capture_output=True, text=True, cwd=parent_directory)
