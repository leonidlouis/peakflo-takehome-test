...
class TestMainScript(unittest.TestCase):
    ...
    def test_validate_csv_data_invalid_combination(self):
        ...
        self.assertEqual(str(context.exception), "Invalid journey combination: line1 to line3")
    ...
    def test_validate_csv_data_invalid_date_format(self):
        ...
        self.assertEqual(str(context.exception), "Invalid 'date_time' format: 2023-09-14 12:00:00")
